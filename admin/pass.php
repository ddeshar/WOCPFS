...
<!--<div id="header-logoff"><a href="http://<?php echo $_SERVER['SERVER_ADDR'] ?>:8002/index.php?zone=buwifi">ไปที่หน้าล็อกอิน</a>&raquo; เปลี่ยนรหัสผ่าน</div>-->
<div id="header-logoff"><a href="http://www.phoubon.in.th">เข้าสู่อินเทอร์เน็ต</a> &raquo; เปลี่ยนรหัสผ่าน</div>
    </div>
    <div id="body">
    	<a href="pass.php">
  ...
  <table width="100%" border="0" cellspacing="5" cellpadding="0">
            ...
            <?php if(!empty($message)) {  ?>
              <tr>
                ...
                <!--<td colspan="2" align="center"><BR /><input name="" type="button" class="button" value="เข้าสู่ระบบ" onclick="window.location='http://<?php echo $_SERVER['SERVER_ADDR'] ?>:8002/index.php?zone=buwifi'" style="cursor:hand" /></td>
				-->
                <td colspan="2" align="center"><BR /><input name="" type="button" class="button" value=" เข้าสู่ระบบ " onclick="window.location='http://www.phoubon.in.th'" style="cursor:hand" /></td>
              </tr>
            <?php } ?>
	        <?php if(empty($message)) { ?>
			<?php if($error[4]) { ?>
